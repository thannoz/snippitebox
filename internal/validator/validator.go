...
// A generic PermittedValue() function. This returns
...
// Matches return true if a value matches a provided compiled regular expression pattern
func Matches(value string, rx *regexp.Regexp) bool {
	return rx.MatchString(value)
}

// addNonFieldError add error msgs to the NonFieldErrors slice
